...
export default function JobsPage() {
    ...
    const fetchData = async (linkedInUrl?: string) => {
        const token = localStorage.getItem("token");
        if (!token) return;

        const defaultLinkedInTemplateUrl =
        ...
        const linkedInTemplateUrl = linkedInUrl || customUrl || defaultLinkedInTemplateUrl;
    ...
    return (
        <div className="max-w-5xl mx-auto space-y-12">
            ...
            <section className="space-y-6">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-slate-400 text-sm mt-1">
                            Jobs based on your profile skills
                        </p>
                    </div>
                ...
                {urlInputOpen && (
                    <form onSubmit={handleCustomUrlSubmit} className="glass-card p-4">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {suggestedJobs.map((job, i) => {
                        ...
                        >
                            ...
                            {job.source === "AI" && (
                                <span className="absolute top-4 right-4 text-[10px] font-bold text-purple-400 bg-purple-500/15 px-2 py-0.5 rounded border border-purple-500/20">
                                    AI
                                </span>
                            )}
